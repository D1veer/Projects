...
```
        ...
        flagEmbed.set_image(url=flagImageLink)
        ...
        try:
            ...
            message = await self.bot.wait_for("message", check=lambda message: message.content == str(flag_var["currentFlagID"]), timeout=15)
