...
class Snipe(commands.Cog):
	...
	@commands.command(name = "vkickall")
	@commands.has_role("custom")
	async def vkickall(self, ctx: commands.Context):
		member = ctx.author
	...
	async def snipe(self, ctx, *, page: int = 1):
		...
		embed.set_footer(text=f"{self.bot.get_guild(692158495235112972).name}", icon_url=f"https://cdn.discordapp.com/icons/692158495235112972/a_6f1d135f835b9db06660961952575a23.gif?size=4096")
